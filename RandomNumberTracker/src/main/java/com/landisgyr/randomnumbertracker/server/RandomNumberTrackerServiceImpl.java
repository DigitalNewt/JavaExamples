...
import com.landisgyr.randomnumbertracker.client.RandomNumberTrackerService;
 ...
 * Time: 10:35 PM
 */
public class RandomNumberTrackerServiceImpl extends RemoteServiceServlet implements RandomNumberTrackerService {
     ...
     */
    public ArrayList<FirstDigitCount> getFirstDigitCountReport(int numbersToGenerate) {
        ArrayList<FirstDigitCount> firstDigitCountList = new ArrayList<>();
        int number = 0;
