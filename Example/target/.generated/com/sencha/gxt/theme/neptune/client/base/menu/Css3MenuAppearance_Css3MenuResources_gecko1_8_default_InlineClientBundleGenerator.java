...
public class Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator implements com.sencha.gxt.theme.neptune.client.base.menu.Css3MenuAppearance.Css3MenuResources {
  private static Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator _instance0 = new Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.neptune.client.base.menu.Css3MenuAppearance.Css3MenuStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GJE5YCFCHRC{outline:" + ("0"+ " " +"none")  + ";background:" + ("-webkit-linear-gradient(" + "left"+ ","+ " " +theme().menu().gradient() + "" + ")")  + ";background:" + ("-o-linear-gradient(" + "left"+ ","+ " " +theme().menu().gradient() + "" + ")")  + ";background:" + ("-ms-linear-gradient(" + "left"+ ","+ " " +theme().menu().gradient() + "" + ")")  + ";background:" + ("linear-gradient(" + "to"+ " " +"right"+ ","+ " " +theme().menu().gradient() + "" + ")")  + ";border-color:" + (theme().menu().border().color() + "")  + ";border-width:" + (theme().menu().border().toString() + "")  + ";border-style:" + (theme().menu().border().style() + "")  + ";-moz-outline:" + ("none")  + ";}.GJE5YCFCHRC a{text-decoration:" + ("none")  + " !important;}.GJE5YCFCIRC{padding:") + ((theme().menu().padding().toString() + "")  + ";background:" + ("transparent")  + ";border:" + ("0"+ " " +"none")  + ";overflow:" + ("hidden")  + ";overflow-y:" + ("hidden")  + ";}.GJE5YCFCGRC{padding:" + ("0")  + " !important;}.GJE5YCFCGRC .GJE5YCFCIRC{padding:" + ("0")  + ";}.GJE5YCFCJRC{padding-right:" + ("27px")  + " !important;}.GJE5YCFCPRC{background-image:" + ("none")  + ";}.GJE5YCFCASC{background-color:" + ("#fff")  + " !important;}.GJE5YCFCORC{height:" + ((Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getHeight() + "px") ) + (";width:" + ((Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getSafeUri().asString() + "\") -" + (Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getLeft() + "px -" + (Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getTop() + "px  no-repeat")  + ";}.GJE5YCFCNRC{height:" + ((Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getHeight() + "px")  + ";width:" + ((Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getSafeUri().asString() + "\") -" + (Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getLeft() + "px -" + (Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getTop() + "px  no-repeat")  + ";}.GJE5YCFCLRC{margin:" + ("0")  + ";width:" + ("100%")  + ";background-position:" + ("center")  + ";height:") + (("8px")  + ";line-height:" + ("8px")  + ";cursor:" + ("pointer")  + ";padding:" + ("0")  + ";border-width:" + ("1px"+ " " +"0")  + ";}.GJE5YCFCMRC{height:" + ("6px")  + ";line-height:" + ("6px")  + ";}")) : ((".GJE5YCFCHRC{outline:" + ("0"+ " " +"none")  + ";background:" + ("-webkit-linear-gradient(" + "left"+ ","+ " " +theme().menu().gradient() + "" + ")")  + ";background:" + ("-o-linear-gradient(" + "left"+ ","+ " " +theme().menu().gradient() + "" + ")")  + ";background:" + ("-ms-linear-gradient(" + "left"+ ","+ " " +theme().menu().gradient() + "" + ")")  + ";background:" + ("linear-gradient(" + "to"+ " " +"right"+ ","+ " " +theme().menu().gradient() + "" + ")")  + ";border-color:" + (theme().menu().border().color() + "")  + ";border-width:" + (theme().menu().border().toString() + "")  + ";border-style:" + (theme().menu().border().style() + "")  + ";-moz-outline:" + ("none")  + ";}.GJE5YCFCHRC a{text-decoration:" + ("none")  + " !important;}.GJE5YCFCIRC{padding:") + ((theme().menu().padding().toString() + "")  + ";background:" + ("transparent")  + ";border:" + ("0"+ " " +"none")  + ";overflow:" + ("hidden")  + ";overflow-y:" + ("hidden")  + ";}.GJE5YCFCGRC{padding:" + ("0")  + " !important;}.GJE5YCFCGRC .GJE5YCFCIRC{padding:" + ("0")  + ";}.GJE5YCFCJRC{padding-left:" + ("27px")  + " !important;}.GJE5YCFCPRC{background-image:" + ("none")  + ";}.GJE5YCFCASC{background-color:" + ("#fff")  + " !important;}.GJE5YCFCORC{height:" + ((Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getHeight() + "px") ) + (";width:" + ((Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getSafeUri().asString() + "\") -" + (Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getLeft() + "px -" + (Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getTop() + "px  no-repeat")  + ";}.GJE5YCFCNRC{height:" + ((Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getHeight() + "px")  + ";width:" + ((Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getSafeUri().asString() + "\") -" + (Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getLeft() + "px -" + (Css3MenuAppearance_Css3MenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getTop() + "px  no-repeat")  + ";}.GJE5YCFCLRC{margin:" + ("0")  + ";width:" + ("100%")  + ";background-position:" + ("center")  + ";height:") + (("8px")  + ";line-height:" + ("8px")  + ";cursor:" + ("pointer")  + ";padding:" + ("0")  + ";border-width:" + ("1px"+ " " +"0")  + ";}.GJE5YCFCMRC{height:" + ("6px")  + ";line-height:" + ("6px")  + ";}"));
      }
