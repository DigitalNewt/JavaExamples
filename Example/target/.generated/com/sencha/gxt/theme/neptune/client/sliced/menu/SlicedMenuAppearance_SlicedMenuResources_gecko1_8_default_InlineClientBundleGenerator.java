...
public class SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator implements com.sencha.gxt.theme.neptune.client.sliced.menu.SlicedMenuAppearance.SlicedMenuResources {
  private static SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator _instance0 = new SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.neptune.client.sliced.menu.SlicedMenuAppearance.SlicedMenuStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GJE5YCFCIID{width:" + ((SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.background()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.background()).getSafeUri().asString() + "\") -" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.background()).getLeft() + "px -" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.background()).getTop() + "px  repeat-y")  + ";outline:" + ("0"+ " " +"none")  + ";width:" + ("auto")  + ";background-color:" + (theme().menu().lastGradientColor() + "")  + ";border-color:" + (theme().menu().border().color() + "")  + ";border-width:" + (theme().menu().border().toString() + "")  + ";border-style:" + (theme().menu().border().style() + "")  + ";-moz-outline:" + ("none")  + ";}.GJE5YCFCIID a{text-decoration:") + (("none")  + " !important;}.GJE5YCFCJID{padding:" + (theme().menu().padding().toString() + "")  + ";background:" + ("transparent")  + ";border:" + ("0"+ " " +"none")  + ";overflow:" + ("hidden")  + ";overflow-y:" + ("hidden")  + ";}.GJE5YCFCHID{padding:" + ("0")  + " !important;}.GJE5YCFCHID .GJE5YCFCJID{padding:" + ("0")  + ";}.GJE5YCFCMID{background-repeat:" + ("no-repeat")  + ";height:" + ("8px")  + ";line-height:" + ("8px") ) + (";cursor:" + ("pointer")  + ";padding:" + ("0")  + ";border-width:" + ("1px"+ " " +"0")  + ";}.GJE5YCFCNID{height:" + ("6px")  + ";line-height:" + ("6px")  + ";}.GJE5YCFCKID{padding-right:" + ("27px")  + " !important;}.GJE5YCFCAJD{background-image:" + ("none")  + ";}.GJE5YCFCBJD{background-color:" + ("#fff")  + " !important;}.GJE5YCFCPID{height:" + ((SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getHeight() + "px")  + ";width:" + ((SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getWidth() + "px")  + ";overflow:") + (("hidden")  + ";background:" + ("url(\"" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getSafeUri().asString() + "\") -" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getLeft() + "px -" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getTop() + "px  no-repeat")  + ";}.GJE5YCFCOID{height:" + ((SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getHeight() + "px")  + ";width:" + ((SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getSafeUri().asString() + "\") -" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getLeft() + "px -" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getTop() + "px  no-repeat")  + ";}.GJE5YCFCMID{margin:" + ("0")  + ";width:" + ("100%")  + ";background-position:" + ("center")  + ";}")) : ((".GJE5YCFCIID{width:" + ((SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.background()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.background()).getSafeUri().asString() + "\") -" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.background()).getLeft() + "px -" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.background()).getTop() + "px  repeat-y")  + ";outline:" + ("0"+ " " +"none")  + ";width:" + ("auto")  + ";background-color:" + (theme().menu().lastGradientColor() + "")  + ";border-color:" + (theme().menu().border().color() + "")  + ";border-width:" + (theme().menu().border().toString() + "")  + ";border-style:" + (theme().menu().border().style() + "")  + ";-moz-outline:" + ("none")  + ";}.GJE5YCFCIID a{text-decoration:") + (("none")  + " !important;}.GJE5YCFCJID{padding:" + (theme().menu().padding().toString() + "")  + ";background:" + ("transparent")  + ";border:" + ("0"+ " " +"none")  + ";overflow:" + ("hidden")  + ";overflow-y:" + ("hidden")  + ";}.GJE5YCFCHID{padding:" + ("0")  + " !important;}.GJE5YCFCHID .GJE5YCFCJID{padding:" + ("0")  + ";}.GJE5YCFCMID{background-repeat:" + ("no-repeat")  + ";height:" + ("8px")  + ";line-height:" + ("8px") ) + (";cursor:" + ("pointer")  + ";padding:" + ("0")  + ";border-width:" + ("1px"+ " " +"0")  + ";}.GJE5YCFCNID{height:" + ("6px")  + ";line-height:" + ("6px")  + ";}.GJE5YCFCKID{padding-left:" + ("27px")  + " !important;}.GJE5YCFCAJD{background-image:" + ("none")  + ";}.GJE5YCFCBJD{background-color:" + ("#fff")  + " !important;}.GJE5YCFCPID{height:" + ((SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getHeight() + "px")  + ";width:" + ((SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getWidth() + "px")  + ";overflow:") + (("hidden")  + ";background:" + ("url(\"" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getSafeUri().asString() + "\") -" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getLeft() + "px -" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniTop()).getTop() + "px  no-repeat")  + ";}.GJE5YCFCOID{height:" + ((SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getHeight() + "px")  + ";width:" + ((SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getSafeUri().asString() + "\") -" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getLeft() + "px -" + (SlicedMenuAppearance_SlicedMenuResources_gecko1_8_default_InlineClientBundleGenerator.this.miniBottom()).getTop() + "px  no-repeat")  + ";}.GJE5YCFCMID{margin:" + ("0")  + ";width:" + ("100%")  + ";background-position:" + ("center")  + ";}"));
      }
