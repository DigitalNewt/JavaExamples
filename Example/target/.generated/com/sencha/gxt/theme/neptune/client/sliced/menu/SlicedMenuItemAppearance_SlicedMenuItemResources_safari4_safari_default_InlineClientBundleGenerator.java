...
public class SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator implements com.sencha.gxt.theme.neptune.client.sliced.menu.SlicedMenuItemAppearance.SlicedMenuItemResources {
  private static SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator _instance0 = new SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator();
  ...
  private void styleInitializer() {
    style = new com.sencha.gxt.theme.neptune.client.sliced.menu.SlicedMenuItemAppearance.SlicedMenuItemStyle() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GJE5YCFCHJD{display:" + ("block")  + ";outline-style:" + ("none")  + ";outline-width:" + ("0")  + ";padding:" + ("0"+ " " +"27px"+ " " +"0"+ " " +"21px")  + ";text-decoration:" + ("none")  + ";white-space:" + ("nowrap")  + ";}.GJE5YCFCKJD{white-space:" + ("nowrap")  + ";display:" + ("block")  + ";padding:" + (theme().menu().activeItemBorder().toString() + "")  + ";margin:" + (theme().menu().itemPadding().toString() + "")  + ";cursor:") + (("pointer")  + ";font-size:" + (theme().menu().itemText().size() + "")  + ";font-family:" + (theme().menu().itemText().family() + "")  + ";font-weight:" + (theme().menu().itemText().weight() + "")  + ";line-height:" + (theme().menu().itemLineHeight() + "")  + ";color:" + (theme().menu().itemText().color() + "")  + ";}.GJE5YCFCJJD{border:" + ("0"+ " " +"none")  + ";height:" + ("16px")  + ";padding:" + ("0")  + ";vertical-align:" + ("top")  + ";width:" + ("16px") ) + (";position:" + ("absolute")  + ";right:" + ("3px")  + ";margin:" + ("3px"+ " " +"0"+ " " +"0")  + ";}.GJE5YCFCIJD{height:" + ((SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.menuParent()).getHeight() + "px")  + ";width:" + ((SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.menuParent()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.menuParent()).getSafeUri().asString() + "\") -" + (SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.menuParent()).getLeft() + "px -" + (SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.menuParent()).getTop() + "px  no-repeat")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";background-position:" + ("left")  + ";background-repeat:") + (("no-repeat")  + ";}.GJE5YCFCGJD{height:" + ((SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.itemOver()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.itemOver()).getSafeUri().asString() + "\") -" + (SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.itemOver()).getLeft() + "px -" + (SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.itemOver()).getTop() + "px  repeat-x")  + ";height:" + ("auto")  + ";border-color:" + (theme().menu().activeItemBorder().color() + "")  + ";border-width:" + (theme().menu().activeItemBorder().toString() + "")  + ";border-style:" + (theme().menu().activeItemBorder().style() + "")  + ";padding:" + ("0")  + " !important;}")) : ((".GJE5YCFCHJD{display:" + ("block")  + ";outline-style:" + ("none")  + ";outline-width:" + ("0")  + ";padding:" + ("0"+ " " +"21px"+ " " +"0"+ " " +"27px")  + ";text-decoration:" + ("none")  + ";white-space:" + ("nowrap")  + ";}.GJE5YCFCKJD{white-space:" + ("nowrap")  + ";display:" + ("block")  + ";padding:" + (theme().menu().activeItemBorder().toString() + "")  + ";margin:" + (theme().menu().itemPadding().toString() + "")  + ";cursor:") + (("pointer")  + ";font-size:" + (theme().menu().itemText().size() + "")  + ";font-family:" + (theme().menu().itemText().family() + "")  + ";font-weight:" + (theme().menu().itemText().weight() + "")  + ";line-height:" + (theme().menu().itemLineHeight() + "")  + ";color:" + (theme().menu().itemText().color() + "")  + ";}.GJE5YCFCJJD{border:" + ("0"+ " " +"none")  + ";height:" + ("16px")  + ";padding:" + ("0")  + ";vertical-align:" + ("top")  + ";width:" + ("16px") ) + (";position:" + ("absolute")  + ";left:" + ("3px")  + ";margin:" + ("3px"+ " " +"0"+ " " +"0")  + ";}.GJE5YCFCIJD{height:" + ((SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.menuParent()).getHeight() + "px")  + ";width:" + ((SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.menuParent()).getWidth() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.menuParent()).getSafeUri().asString() + "\") -" + (SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.menuParent()).getLeft() + "px -" + (SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.menuParent()).getTop() + "px  no-repeat")  + ";height:" + ("auto")  + ";width:" + ("auto")  + ";background-position:" + ("right")  + ";background-repeat:") + (("no-repeat")  + ";}.GJE5YCFCGJD{height:" + ((SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.itemOver()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.itemOver()).getSafeUri().asString() + "\") -" + (SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.itemOver()).getLeft() + "px -" + (SlicedMenuItemAppearance_SlicedMenuItemResources_safari4_safari_default_InlineClientBundleGenerator.this.itemOver()).getTop() + "px  repeat-x")  + ";height:" + ("auto")  + ";border-color:" + (theme().menu().activeItemBorder().color() + "")  + ";border-width:" + (theme().menu().activeItemBorder().toString() + "")  + ";border-style:" + (theme().menu().activeItemBorder().style() + "")  + ";padding:" + ("0")  + " !important;}"));
      }
